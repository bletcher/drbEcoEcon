...
if (tar_exist_objects(c("tt_modelOut_main"))) {
  ...
  #MCMCplot(object = mod_tt_main$mcmc, params = "betaPhiOut")
  #MCMCplot(object = mod_tt_main$mcmc, params = "betaPOut")
...
if (tar_exist_objects(c("tt_modelOut_trib"))) {
  ...
  #MCMCplot(object = mod_tt_trib$mcmc, params = "betaPhiOut")
  priors <- rnorm(tar_read(tt_runData_trib)$nIter * tar_read(tt_runData_trib)$nChains, 0, 1/sqrt(.1))
